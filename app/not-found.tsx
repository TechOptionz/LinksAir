...
export default function NotFound() {
  return (
    <div style={sx('max-width:720px;margin:0 auto;padding:clamp(56px,10vw,120px) 20px;text-align:center')}>
      ...
      <Link href="/" style={sx('display:inline-block;background:#1279BF;color:#fff;border-radius:12px;padding:15px 26px;font-family:Barlow,sans-serif;font-weight:700;font-size:17px')}>Back to home</Link>
    </div>
  );
}
